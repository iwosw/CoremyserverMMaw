...
public class Coremmaw {
    ...
    // Creates a new food item with the id "coremmaw:example_id", nutrition 1 and saturation 2
    public static final RegistryObject<Item> EXAMPLE_ITEM = ITEMS.register("example_item", () -> new Item(new Item.Properties().food(new FoodProperties.Builder().alwaysEat().nutrition(1).saturationMod(2f).build())));

    // Creates a creative tab with the id "coremmaw:example_tab" for the example item, that is placed after the combat tab
